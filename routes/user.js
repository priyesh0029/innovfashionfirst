...
//coupen
router.route('/availableCoupen') 
    .get(userauths.userAuth,controller.getAvailableCoupen)
    .post(userauths.userAuth,controller.postAjaxCouponDiscount)

router.post('/removeCoupen', userauths.userAuth, controller.postAjaxremoveCoupen)
